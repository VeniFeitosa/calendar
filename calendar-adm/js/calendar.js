(function ($) {
    ...
    var defaults = {
      ...
      onClickDate: function (date) {
        ...
        modalTitle.innerHTML = `${data.getDate()} de ${monthMap[data.getMonth() + 1]} de ${data.getFullYear()}`
    ...
    function generateWeekDOM(monthData, currentDate) {
      var str = "";
      str += '<div class="weeks-wrapper dias">';
      ...
      monthData.forEach(function (week, weekNo) {
        ...
        week.forEach(function (day, dayNo) {
          ...
          //valor caso o dia tenha anotação
          let isMessage = '<div class="day position-relative' +
          disabled +
          selected +
          today +
          '" data-bs-toggle="modal" data-bs-target="#exampleModal" data-date="' +
          day +
          '" ' +
          dateDisabled +
          ' ><span class="dateSpan">' +
          day.getDate() +
          '</span><span class="dateBadge position-absolute translate-middle p-2 bg-success border border-light rounded-circle"></span></div>';
          
          //valor caso o dia não tenha anotação
          let notAnyMessage = '<div class="day position-relative' +
          disabled +
          selected +
          today +
          '" data-bs-toggle="modal" data-bs-target="#exampleModal" data-date="' +
          ...
          '" ' +
          dateDisabled +
          ' ><span class="dateSpan position-relative">' +
          day.getDate() +
          '</span></div>';
